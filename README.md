...
This repository contains all files (code, data, report, GIS project) to perform the operations for the Nicola Watershed Ranking Framework. See general overview of files below.
