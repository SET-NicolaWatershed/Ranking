...
To download all files as a zip file: i) Click the green "<Code>" button (top right of the file list); ii) From the dropdown list - click "Download Zip"; iii) Right-click zip file and 'Extract All'
